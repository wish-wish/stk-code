...
void AbstractCharacteristic::process(CharacteristicType type, Value value,
                                     bool *is_set) const
{
    logwarn("AbstractCharacteristic", "This type does not do anything");
}   // process
    ...
    CharacteristicType type)
{
    ...
    case CHARACTERISTIC_COUNT:
        logfatal("AbstractCharacteristic::getType", "Can't get type of COUNT");
        break;
    ...
    logfatal("AbstractCharacteristic::getType", "Unknown type");
    return TYPE_FLOAT;
}   // getType
...
std::string AbstractCharacteristic::getName(CharacteristicType type)
{
    ...
    logerror("AbstractCharacteristic::getName", "Unknown type");
    return "Unknown type";
}   // getName
...
float AbstractCharacteristic::getSuspensionStiffness() const
{
    ...
    if (!is_set)
        logfatal("AbstractCharacteristic", "Can't get characteristic %s",
